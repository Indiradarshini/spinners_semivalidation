...
public class SpecializationController {
	...
	// public String processSpec(@RequestParam String idInput, @RequestParam String titleInput,
	// @RequestParam String descriptionInput, @Validated Specialization Specialization,
	...
	// @PostMapping("admin/newspec")
	// public ResponseEntity<?> processSpec(
	// @ModelAttribute("SpecializationInput") @Validated SpecializationInput specializationInput,
